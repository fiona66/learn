...
//        static final String DB_URL = "jdbc:mysql://sql12.freemysqlhosting.net:3306/sql12173107";
    ...
    public void addToMySQL(int afterToday) throws IOException, ParseException {
...
//        date currentdate=date.getTime();
        ...
        int minprice=flight.getMinPrice(afterToday);
        Object getFlightNumber = flight.getFlightNumber(afterToday);
        String getDapatureDate = flight.getDepartureTime(afterToday);
        try{
            ...
            String sql2="INSERT INTO flightminprice(flight_num,minprice,querytime,departure_date) VALUES ('"+ getFlightNumber +"' ,'"+ minprice +"','"+ ft.format(date)+"','"+ getDapatureDate +"')";
